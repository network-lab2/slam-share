...
{
   //GLOBAL Variable
extern boost::interprocess::managed_shared_memory segment;//(boost::interprocess::open_or_create, "MySharedMemory",10737418240);
...
public:
    ...
    std::vector<boost::interprocess::offset_ptr<MapPoint> > GetTrackedMapPoints();
...
private:
    ...
    // Tracking state
    int mTrackingState;
    std::vector<boost::interprocess::offset_ptr<MapPoint> > mTrackedMapPoints;

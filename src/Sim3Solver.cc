...
Sim3Solver::Sim3Solver(boost::interprocess::offset_ptr<KeyFrame> pKF1, boost::interprocess::offset_ptr<KeyFrame> pKF2, const vector<boost::interprocess::offset_ptr<MapPoint> > &vpMatched12, const bool bFixScale,
                       vector<boost::interprocess::offset_ptr<KeyFrame> > vpKeyFrameMatchedMP):
    ...
    pCamera1(pKF1->mpCamera), pCamera2(pKF2->mpCamera)
{
    ...
    {
        bDifferentKFs = true;
        vpKeyFrameMatchedMP = vector<boost::interprocess::offset_ptr<KeyFrame> >(vpMatched12.size(), pKF2);
    }

    mpKF1 = pKF1;
    mpKF2 = pKF2;

    vector<boost::interprocess::offset_ptr<MapPoint> > vpKeyFrameMP1 = pKF1->GetMapPointMatches();
    ...
    boost::interprocess::offset_ptr<KeyFrame>  pKFm = pKF2; //Default variable
    for(int i1=0; i1<mN1; i1++)
    {
        if(vpMatched12[i1])
        {
            boost::interprocess::offset_ptr<MapPoint>  pMP1 = vpKeyFrameMP1[i1];
            boost::interprocess::offset_ptr<MapPoint>  pMP2 = vpMatched12[i1];

...
void System::PostLoad(){
    ...
    if (*magic_num > 3)
    {
        ...
        std::cout<<"Num of mvBackupKeyFrameOriginsId in another atlas: "<<otherAtlas->currentMapPtr->mvpKeyFrameOrigins[0]->mTimeStamp<<std::endl;
        ...
        // print the number of keyframes.
        std::cout<<"Num of mvBackupKeyFrameOriginsId in THIS atlas: "<<otherAtlas->currentMapPtr->mvpKeyFrameOrigins[0]->mTimeStamp<<std::endl;
    }

...
void System::PostLoad(){
    ...
    if (*magic_num > 3)
    {
        ...
        std::cout<<"Point distribution of Other Atlas: (NLeft) "<<otherAtlas->currentMapPtr->GetOriginKF()->NLeft<<std::endl;
        ...
        std::cout<<"Point distribution of This Atlas:(NLeft) "<<otherAtlas->currentMapPtr->GetOriginKF()->NLeft<<std::endl;
